...
export default function Cover() {
  return (
    <Section name={"Cover"} className="flex items-center justify-center" withoutTitle>
      <div className="space-y-4 font-medium">
        <p className="text-lg text-subtle">Hey, I am</p>
        <h2 className={`${rubik.className} text-7xl font-bold uppercase tracking-wide text-primary`}>Shinjith P R</h2>
